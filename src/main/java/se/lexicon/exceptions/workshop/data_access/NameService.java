...
public class NameService {
    ...
    public void addFemaleFirstName(String name) throws DuplicateNameException {
        if (!femaleFirstNames.contains(name)) {
            ...
            System.out.println("Female name " + name + " successfully added to database.");
        } else {
    ...
    public void addMaleFirstName(String name) throws DuplicateNameException {
        if (!maleFirstNames.contains(name)) {
            ...
            System.out.println("Male name " + name + " successfully added to database.");
        } else {
    ...
    public void addLastName(String lastName) throws DuplicateNameException {
        if (!lastNames.contains(lastName)) {
            ...
            System.out.println("Last name " + lastName + " successfully added to database.");
        } else {
            throw new DuplicateNameException("Duplicate last name " + lastName + " found. Entry not added.");
        }
    }
